...
class RemoteController(Node): 
   def __init__(self): 
      ...
      self.throttle_pub = self.create_publisher(Int64,'lw_portena_throttle', 10)
      self.brake_pub = self.create_publisher(Int64, 'lw_portena_brake', 10)
      self.steering_pub = self.create_publisher(Int64, 'lw_portena_steering', 10)
